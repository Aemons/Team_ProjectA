...
#include "SOS_BTT_DistanceMove.generated.h"

/**
 * 
 */
UCLASS()
class TEAM_PROJECTA_API USOS_BTT_DistanceMove : public UBTTaskNode
{
	GENERATED_BODY()

public:
	USOS_BTT_DistanceMove();
...
private:
	...
	float NearDistance = 300.0f; // Degrees per second
